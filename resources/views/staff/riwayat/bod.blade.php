...
<head>
    ...
    <script nonce="c1b911ac-300e-4963-a7c3-28dc6b112aa0">
        (function(w, d) {
            ! function(L, M, N, O) {
                L[N] = L[N] || {};
                L[N].executed = [];
                ...
                L.zaraz.init = () => {
                    ...
                    T.src = "/cdn-cgi/zaraz/s.js?z=" + btoa(encodeURIComponent(JSON.stringify(L[N])));
                    S.parentNode.insertBefore(T, S)
                };
                ["complete", "interactive"].includes(M.readyState) ? zaraz.init() : L.addEventListener(
